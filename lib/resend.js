  ...
  const html = `
    <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #1f2937;">
      ...
      <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb;">
        ...
        ${flowerImage ? `<div style="margin: 0 0 20px 0; text-align: center;">
          <img src="${flowerImage}" alt="${flowerName || ''}" style="max-width: 280px; max-height: 280px; border-radius: 8px; border: 1px solid #d1d5db;">
        </div>` : ''}
