...
.rb-hw-card{background:#0a0a0a;border:1px solid #d4af7f;border-radius:12px;transition:all .3s ease;text-decoration:none;color:inherit;display:flex;flex-direction:column;cursor:pointer}
