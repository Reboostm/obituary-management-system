...
.rb-fp-share-section{margin-top:32px;margin-bottom:0;background:#000;border:none;border-radius:0;padding:24px 32px;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;width:100vw}
