      ...
      <head>
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .rb-hw-img { width: 100%; height: 265px; object-fit: contain; object-position: center center; display: block; background: #111; flex-shrink: 0; }
          .rb-hw-placeholder { width: 100%; height: 265px; background: #1a1a1a; display: flex; align-items: center; justify-content: center; font-size: 4rem; color: #d4af7f; flex-shrink: 0; }
          ...
          .rb-hw-btn { background: transparent; color: #d4af7f; border: 1px solid #d4af7f; border-radius: 6px; padding: 10px 14px; font-size: 1rem; font-weight: 600; cursor: pointer; margin-top: auto; transition: all .2s; font-family: inherit; width: 100%; letter-spacing: .03em; }
