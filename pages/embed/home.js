      ...
      <head>
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .rb-hw-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); grid-auto-rows: max-content; gap: 24px; width: 100%; height: auto; }
          ...
          .rb-hw-img { width: 100%; height: 280px; object-fit: contain; object-position: center center; display: block; background: #111; flex-shrink: 0; }
          .rb-hw-placeholder { width: 100%; height: 280px; background: #1a1a1a; display: flex; align-items: center; justify-content: center; font-size: 4rem; color: #d4af7f; flex-shrink: 0; }
          .rb-hw-content { padding: 12px; flex: 1; display: flex; flex-direction: column; justify-content: space-between; min-height: 0; }
          .rb-hw-name { color: #d4af7f; font-size: 1.3rem; font-weight: 600; margin-bottom: 4px; line-height: 1.3; word-break: break-word; }
          .rb-hw-dates { color: #d1d5db; font-size: 0.95rem; margin-bottom: 12px; }
